// Futsal Model - UI Controller
// Handles user interactions and displays results from FutsalEngine
...
document.addEventListener('DOMContentLoaded', () => {
    FutsalAPI.setRunModelCallback(window.runModel);
    FutsalAPI.initLoader();
    ...
    if (leagueSelect) {
        leagueSelect.addEventListener('change', FutsalAPI.handleLeagueChange);
    }

    if (matchSelect) {
        matchSelect.addEventListener('change', FutsalAPI.handleMatchChange);
    }
